...
def generate_riddle(difficulty, user_id):
    ...
    - 答え: 「1」
    - 解説:  ２つのサイコロが重なったとき上から見ると１つの数字しか見えなくなるから
    3. 「数の単位は１、数量は２、名前は３ これなーんだ？」
    - 答え: 「サンダル」
    - 解説:  1足、2つ、3ダル
    ...
    - 答えは1単語のみ出力してください。
    - 答えは全てひらがなに変換してください。
    - {difficulty}が難しいの時だけ、問題と答えと解説を出力してください
    - 解説はなぜその答えになるのかを簡潔に50文字以内の文章にしてください
